	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#work" class="smoothScroll">ОБО МНЕ</a></li>
...
<!--					<strong>01</strong>-->
					<h1 class="heading bold">ПРИЯТНО ПОЗНАКОМИТЬСЯ</h1>
					<hr>
				</div>
			</div>
			...
			<div class="col-lg-8 col-md-8 col-sm-8 wow fadeInUp" data-wow-delay="1s">
					...
					<hr> -->
					<div class="aydentika">
						<p>Моя стихия – айдентика. В ней я чувствую себя как птица в небе. Все ее направления – это просторы, дающие возможность доказать миру, что дизайн – это двигатель современной торговли. </p>
						<p>Айдентика – это искусство, бренд – полотно. Я же в свою очередь художник, старающийся ломать устоявшиеся стереотипы о современном дизайне.</p>
					</div>
	...
	<a name="top"></a>
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="section-title">
<!--					<strong>04</strong>-->
					<h1 class="heading bold">ПОРТФОЛИО</h1>
...
<!--		Brand Begin		-->
				...
				<div id="hide-me-1" class="collapse after-logo">
				    ...
				    <div class="row">
							...
							<p>
								Компания осуществляет поставки электротехнического оборудования, компонентов промышленной автоматики, а также промышленных компьютерных систем, которые используются в различных производственных процессах.
							</p>
...
<!--		Brand End		-->
				...
				<div id="hide-me-2" class="collapse after-logo">
				    ...
				    <div class="row">
							...
							<div class="col-md-6 col-md-offset-3">
					    <p>
					        Персональный бренд веб-программиста Всеволода Ли. Деятельность программиста: создание адаптивных сайтов, SEO оптимизация кода и сопровождение веб-проектов на всех этапах его развития.
					    </p>
...
<!--		Brand End		-->
				...
				<div id="hide-me-3" class="collapse after-logo">
				    ...
				    <div class="row">
							...
							<div class="col-md-6 col-md-offset-3">
							<p>
								Пекарня, изготавливающая хлеб по мировым стандартам. В данное время пекарня снабжает хлебобулочными изделиями крупнейшие рестораны Ташкента.
							</p>
...
<!--		Brand End		-->
				...
				<div id="hide-me-4" class="collapse after-logo">
				    ...
				    <div class="row">
							...
							<div class="col-md-6 col-md-offset-3">
							<p>
									Дисконт центр Ташкента, открывший свои двери для посетителей совсем недавно.Товары, которые вы можете найти в Besco - это профессиональная кухонная техника, ресторанная посуда и канцтовары.
							</p>
...
<!--		Brand End		-->
				...
				<div id="hide-me-5" class="collapse after-logo">
				    ...
				    <div class="row">
							...
							<div class="col-md-6 col-md-offset-3">
					    <p>
					        Персональный бренд модельера Сурайо (Сипа) Ильхамовой. Под брендом создается одежда из различных национальных тканей, либо с использованием национальных узоров.
					    </p>
...
<!--		Brand End		-->
				...
				<div id="hide-me-6" class="collapse after-logo">
				    ...
				    <div class="row">
							...
							<div class="col-md-6 col-md-offset-3">
					    <p>
					        Модное заведение в стиле лофт, располагающееся в самом центре Ташкента. Данное заведение может похвастаться вкуснейшим кофе, ChillOut атмосферой и внушительной картой меню.
					    </p>
...
<!--		Brand End		-->
				...
				<div id="hide-me-7" class="collapse after-logo">
				    ...
				    <div class="row">
							...
							<div class="col-md-6 col-md-offset-3">
					    <p>
								Уютный симферопольский Lounge Bar на берегу Черного моря. Заведение может порадовать посетителей блюдами кавказкой и европейской кухни, огромным выбором коктейлей, кальянами на любой вкус, а также незабываемым видом на крымский пляж.
					    </p>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 text-center">
				<div class="section-title">
<!--					<strong>06</strong>-->
					<h1 class="heading bold">СВЯЖИТЕСЬ СО МНОЙ</h1>
					<hr>
				</div>
			</div>
			<div class="col-md-6 col-sm-12 contact-info">
				<h2 class="heading bold">КОНТАКТНАЯ ИНФОРМАЦИЯ</h2>
				<p>По вопросам взаимовыгодного сотрудничества свяжитесь со мной любым удобным для Вас способом:</p>
				...
				<div class="col-md-6 col-sm-4">
					<h3><i class="icon-phone medium-icon wow bounceIn" data-wow-delay="0.6s"></i> Телефон</h3>
					<p>+371 2 810-42-96 (Телефон, SMS, WhatsApp)</p>
				</div>
			</div>
			<div class="col-md-6 col-sm-12">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="wow fadeInUp" data-wow-delay="0.6s" id="contactform">
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" placeholder="Имя" name="contactname" id="contactname">
					</div>
					<div class="col-md-6 col-sm-6">
						<input type="email" class="form-control" placeholder="Email" name="email" id="email">
					</div>
					<div class="col-md-12 col-sm-12">
						<textarea class="form-control" placeholder="Сообщение" rows="7" name="message" id="message"></textarea>
					</div>
					<div class="col-md-offset-4 col-md-8 col-sm-offset-4 col-sm-8">
						<input type="submit" class="form-control" value="Отправить" name="submit">
					</div>
				</form>
				<!--  -->
